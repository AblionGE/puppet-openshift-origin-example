...
* Virtualbox (with the possibility to install 64 bits VM because Openshift is only available on 64 bits architectures)
...
- You absolutely need to install Openshift in a 64 bits VM.
